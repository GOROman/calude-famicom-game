...
**🎞 [Animation Player](https://goroman.github.io/calude-famicom-game/tools/animplay/)** — loop-play frames extracted from video (15 frames of the huntress) with frame selection and adjustable FPS; the URL is the save data
